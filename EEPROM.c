...
*	read size bytes from EEprom to destination
*
*/
void readGlobalSet() {
...
void readEEPROM() {
  ...
  for(i=0;i<11;i++) {
	...
	// throttle = min + (MAX-min)*lookupThrottleRC[x] / 1000		dongshan
...
/*
*	eeprom_write_block(*from, *to, size)
*	read size bytes from EEprom to destination
*/
...
/*
*	Load default data as config value. you would see these data in UI interface.
*/
void LoadDefaults() {
